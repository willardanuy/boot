package br.com.express.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.express.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "br.com.express.model" });
